...
export const worldCapitals = [
  ...
  { country: "Holy See (Vatican City)", capital: "Vatican City" },
...
export const periodicElements = [
  ...
  { atomicNumber: 55, symbol: "Cs", name: "Cesium", atomicWeight: "132.91" },
...
export const quizGames = {
  alphabet: {
    ...
    generateQuestion: () => {
      const letter = String.fromCharCode(64 + Math.floor(Math.random() * 26) + 1);
      const correct = letter.charCodeAt(0) - 64;

      return {
        display: letter,
        correctValue: correct,
        options: generateAlphabetOptions(correct),
      };
    },
  },
  square: {
    ...
    generateQuestion: () => {
      ...
      return {
        display: num,
        correctValue: correct,
        options: generateSquareOptions(correct, num),
      };
    },
  },
  stateCapital: {
    ...
    bigLetter: "IND",
    intro: "Recall Indian state capitals at exam speed.",
    rules: "<1s = 12pts · <2s = 8pts · <3s = 4pts · wrong = over",
    reference: "Covers the 28 Indian states only, not union territories.",
    accent: "#fb7185",
    timeLimit: 3000,
    prompt: "Find the capital of",
    subtext: "Choose the correct capital",
    cardBadge: "GK Memory",
    ...
    generateQuestion: () => {
      const question = stateCapitals[Math.floor(Math.random() * stateCapitals.length)];
...
function generateSquareOptions(correct, originalNum) {
  const options = new Set([correct]);
  const wrongAnswers = [
    (originalNum - 1) * (originalNum - 1),
    (originalNum + 1) * (originalNum + 1),
    correct + 10,
    correct - 10,
    correct + 100,
  ...
  while (options.size < 4) {
    let fallback = correct + Math.floor(Math.random() * 50) * (Math.random() > 0.5 ? 1 : -1);
...
function generateCapitalOptions(correctCapital) {
  ...
  const capitals = shuffleArray(stateCapitals.map((item) => item.capital));
...
function generatePeriodicOptions(correctElement) {
  const options = new Set([formatPeriodicOption(correctElement)]);
  const nearbyElements = periodicElements.filter(
    (element) =>
      element.atomicNumber !== correctElement.atomicNumber &&
      Math.abs(element.atomicNumber - correctElement.atomicNumber) <= 8,
  );
  const fallbackElements = periodicElements.filter(
    (element) => element.atomicNumber !== correctElement.atomicNumber,
  );
...
export const companyOriginData = [
  ...
  { company: "Microsoft", country: "USA", category: "Tech" },
  { company: "Google", country: "USA", category: "Tech" },
  { company: "Meta", country: "USA", category: "Tech" },
  { company: "Amazon", country: "USA", category: "Tech" },
  { company: "IBM", country: "USA", category: "Tech" },
  { company: "Oracle", country: "USA", category: "Tech" },
  { company: "Intel", country: "USA", category: "Tech" },
  { company: "Cisco", country: "USA", category: "Tech" },
  { company: "Adobe", country: "USA", category: "Tech" },
  { company: "Baidu", country: "China", category: "Tech" },
  { company: "Alibaba", country: "China", category: "Tech" },
  { company: "Huawei", country: "China", category: "Tech" },
  { company: "Xiaomi", country: "China", category: "Tech" },
  { company: "TSMC", country: "Taiwan", category: "Tech" },
  { company: "Nintendo", country: "Japan", category: "Tech" },
  // Vehicle Companies
  ...
  { company: "Honda", country: "Japan", category: "Vehicle" },
  { company: "Nissan", country: "Japan", category: "Vehicle" },
  { company: "Mazda", country: "Japan", category: "Vehicle" },
  { company: "Subaru", country: "Japan", category: "Vehicle" },
  { company: "Chevrolet", country: "USA", category: "Vehicle" },
  { company: "Tesla", country: "USA", category: "Vehicle" },
  { company: "Mercedes-Benz", country: "Germany", category: "Vehicle" },
  { company: "Audi", country: "Germany", category: "Vehicle" },
  { company: "Porsche", country: "Germany", category: "Vehicle" },
  { company: "Kia", country: "South Korea", category: "Vehicle" },
  { company: "Peugeot", country: "France", category: "Vehicle" },
  { company: "Fiat", country: "Italy", category: "Vehicle" },
  { company: "Jaguar", country: "United Kingdom", category: "Vehicle" },
  { company: "Land Rover", country: "United Kingdom", category: "Vehicle" },
  { company: "Mahindra", country: "India", category: "Vehicle" },
  { company: "Bajaj Auto", country: "India", category: "Vehicle" },
  // Food & Beverage
  ...
  { company: "PepsiCo", country: "USA", category: "Food & Beverage" },
  { company: "McDonald's", country: "USA", category: "Food & Beverage" },
  { company: "Starbucks", country: "USA", category: "Food & Beverage" },
  { company: "KFC", country: "USA", category: "Food & Beverage" },
  { company: "Burger King", country: "USA", category: "Food & Beverage" },
  { company: "Subway", country: "USA", category: "Food & Beverage" },
  { company: "Heineken", country: "Netherlands", category: "Food & Beverage" },
  { company: "Carlsberg", country: "Denmark", category: "Food & Beverage" },
  { company: "Diageo", country: "United Kingdom", category: "Food & Beverage" },
  { company: "Kellogg's", country: "USA", category: "Food & Beverage" },
  // Fashion & Apparel
  ...
  { company: "Puma", country: "Germany", category: "Fashion & Apparel" },
  { company: "Under Armour", country: "USA", category: "Fashion & Apparel" },
  { company: "Levi's", country: "USA", category: "Fashion & Apparel" },
  { company: "Ralph Lauren", country: "USA", category: "Fashion & Apparel" },
  { company: "Calvin Klein", country: "USA", category: "Fashion & Apparel" },
  { company: "Tommy Hilfiger", country: "USA", category: "Fashion & Apparel" },
  { company: "Prada", country: "Italy", category: "Fashion & Apparel" },
  { company: "Versace", country: "Italy", category: "Fashion & Apparel" },
  { company: "Chanel", country: "France", category: "Fashion & Apparel" },
  { company: "Dior", country: "France", category: "Fashion & Apparel" },
  // Electronics & Home
  ...
  { company: "Whirlpool", country: "USA", category: "Electronics" },
  { company: "Electrolux", country: "Sweden", category: "Electronics" },
  { company: "Hitachi", country: "Japan", category: "Electronics" },
  { company: "Toshiba", country: "Japan", category: "Electronics" },
  { company: "Sharp", country: "Japan", category: "Electronics" },
  // Finance & Banking
  { company: "Visa", country: "USA", category: "Finance" },
  { company: "Mastercard", country: "USA", category: "Finance" },
  { company: "American Express", country: "USA", category: "Finance" },
  { company: "JPMorgan Chase", country: "USA", category: "Finance" },
  { company: "Goldman Sachs", country: "USA", category: "Finance" },
  { company: "HSBC", country: "United Kingdom", category: "Finance" },
  { company: "Barclays", country: "United Kingdom", category: "Finance" },
  { company: "Allianz", country: "Germany", category: "Finance" },
  { company: "AXA", country: "France", category: "Finance" },
  { company: "SBI (State Bank of India)", country: "India", category: "Finance" },
  // Retail & E-commerce
  { company: "Walmart", country: "USA", category: "Retail" },
  { company: "Target", country: "USA", category: "Retail" },
  { company: "Costco", country: "USA", category: "Retail" },
  { company: "Home Depot", country: "USA", category: "Retail" },
  { company: "Tesco", country: "United Kingdom", category: "Retail" },
  { company: "Carrefour", country: "France", category: "Retail" },
  { company: "Aldi", country: "Germany", category: "Retail" },
  { company: "Lidl", country: "Germany", category: "Retail" },
  { company: "Flipkart", country: "India", category: "Retail" },
  { company: "Rakuten", country: "Japan", category: "Retail" },
];
...
Object.assign(quizGames, {
  companyOrigin: {
    ...
    rules: "<1s = 12pts · <2s = 8pts · <3s = 4pts · wrong = over",
    reference: "100+ companies across Tech, Vehicles, Food, Fashion, Electronics, Finance, and Retail.",
    accent: "#f43f5e", // Rose
    timeLimit: 3000,
    prompt: "Origin of",

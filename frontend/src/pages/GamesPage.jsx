  ...
  const games = [
    {
      ...
      title: "Tic Tac Toe",
      description:
        "Classic 3x3 game. Play against the AI or challenge a friend in live multiplayer!",
      icon: "❌⭕",
    ...
    },
    {
      ...
      title: "Simon Says",
      description:
        "Watch the pattern, repeat the pattern. Classic memory sequence game with 4 colors!",
      icon: "🧠🎯",
      color: "from-[#40e0f0] to-cyan-500",
      shadow: "shadow-[0_0_15px_rgba(64,224,240,0.2)]",
    },
    {
      ...
      description:
        "Test your luck against the computer or battle a friend in secret selection mode!",
      icon: "✊✋✌️",
    ...
    },
    {
      ...
      description:
        "Step up to the spot! Shoot past the keeper and make spectacular saves.",
      icon: "⚽🧤",
    ...
    },
    {
      ...
      description:
        "Play classic Chess. Outsmart your opponent and capture the King!",
      icon: "♔♚",
    ...
    },
    {
      ...
      description:
        "Experience the stadium atmosphere! Shoot past the keeper in this highly animated penalty game.",
      icon: "🏟️⚽",
    ...
    <main className="mx-auto flex min-h-[calc(100vh-120px)] max-w-5xl flex-col px-3 py-8 sm:px-6 sm:py-10">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-400 max-w-lg mx-auto">
          Take a break from studying and play some classic casual games. Play
          solo against the AI or invite a friend to a lobby!
        </p>
      </div>

...
export const GAME_MODES = [
  ...
  },
  {
    ...
    hero: "🗺️",
    intro: "A state blinks on the map — guess its name or capital!",
    rules: "<1s = 12pts · <2s = 8pts · <3s = 4pts · wrong = over",
    reference: "All 28 Indian states + union territories on an interactive SVG map.",
    accent: "#38bdf8",
    summary: "Identify the blinking state or its capital.",
    details: "An interactive map quiz where a random Indian state blinks and you pick the correct answer from 4 options.",
  },
  {
    id: "stateCapital",
    path: "/state-capital",
